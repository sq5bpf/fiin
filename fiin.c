/* 
   ...
   Copyright (C) 2001,2002 Jacek Lipkowski <sq5bpf@lipkowski.org>
...
{
	printf
		("FIIN v%s, Copyright (C) 2001 Jacek Lipkowski <sq5bpf@lipkowski.org>\n",
		 VER);
...
int check_sig (int size, char *sig)
{
...
int do_generic (char *nam, char *method, char *suffix, int sig_len,
